...
\subfloat[Sensor nodes]{
	\subfloat{\label{fig:deploy-micaz}\includegraphics[width=.2\textwidth]{micaz.jpg}}
	\subfloat{\label{fig:deploy-mib510}\includegraphics[width=.2\textwidth]{mib510.jpg}}}
\qquad
