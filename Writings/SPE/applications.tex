...
\subsection{Support of Applications With PSWare}
Before we take advantage of PSWare in developing these applications, we first analyze if the middleware developers need to modify the event processing framework for each of the individual application scenario.
