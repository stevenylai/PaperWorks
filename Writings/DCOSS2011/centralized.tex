\section{TED-C: Type-based Event Detection with Centralized Fusion Point Selection}
\label{sec:centralized}
In this section, we present centralized TED-C, a distributed type-based composite event detection algorithm for wireless sensor network. TED-C uses a centralized scheme for fusion point selection.
