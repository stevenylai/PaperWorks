...
\begin{figure}
\centering
\subfloat[With random fusion point deployment]{\label{fig:carParkResult1}\includegraphics[width=.5\textwidth]{carParkResult1}}
%\qquad
\subfloat[With even fusion point deployment]{\label{fig:carParkResult2}\includegraphics[width=.5\textwidth]{carParkResult2}}
...
\begin{figure}
\centering
\subfloat[Message cost]{\label{fig:itsResult1}\includegraphics[width=.5\textwidth]{itsResult1}}
%\qquad
\subfloat[Delay]{\label{fig:itsResult2}\includegraphics[width=.5\textwidth]{itsResult2}}
